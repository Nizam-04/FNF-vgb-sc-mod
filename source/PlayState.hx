...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['You Suck!', 0.5], //From 40% to 49%
		['You Suck!', 0.6], //From 50% to 59%
		['You Suck!', 0.69], //From 60% to 68%
		['You Suck!', 0.7], //69%
		['You Suck!', 0.8], //From 70% to 79%
		['You Suck!', 0.9], //From 80% to 89%
		['My Grandma Can Play better than you!', 1], //From 90% to 99%
		['My Grandma Can Play better than you!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
